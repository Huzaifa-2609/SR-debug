...
<div class="text-center text-block-hero py-5 mb-5" style="background-image: url('https://images.unsplash.com/photo-1593214451196-37e0651f8ef2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=80'); background-repeat: no-repeat;background-size: cover;background-size: 100% 100%">
